...
import Rank3 from '../../Assets/Rank-31.svg'
            ...
            <div className="middle"> 
                {
                    Connections ?
                     (
                        <div style={{width: "98%", overflow: "hidden", marginLeft: "-10px"}}>
            ...
            <div className="right-handside">
                {
                    Connections ?
                    (
                        <div style={{backgroundColor: "white", padding: "10px", height: "420px", maxWidth: "500px", overflow: "hidden"}}>
                    ...
                    (
                        <div style={{backgroundColor: "white", padding: "10px", height: "450px"}}>
                            <div style={{display: "flex"}}>
